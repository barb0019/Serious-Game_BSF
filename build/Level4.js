...
export default class Level4 extends Level {
    ...
    objects() {
        ...
        this.scoringObjects.push(new FutPack(width * 0.416, height * 0.5, 'blue', -3));
        ...
        this.scoringObjects.push(new FutPack(width * 0.516, height * 0.5, 'red', -3));
        this.scoringObjects.push(new FutPack(width * 0.616, height * 0.5, 'blue', -3));
