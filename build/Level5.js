...
export default class Level5 extends Level {
    ...
    speedsbubbles(game) {
        ...
        this.speedBubble.push(new SpeedsBubble(game, 'van teveel in-game aankopen kan je in geld problemen komen', this.game.canvas.height * 0.3, this.game.canvas.width * 0.73, 100, 500, 'white'));
    }
    players() {
        this.player = [];
