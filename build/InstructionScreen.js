...
export default class InstructionScreen extends Scene {
    ...
    render() {
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/interactingitems/star.png'), width * 0.2, height * 0.2);
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/door/DoubleDoor0.png'), width * 0.19, height * 0.29);
        this.game.writeTextToCanvas('⬅️', height * 0.027, width * 0.25, height * 0.32, 'center', 'black');
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/player/BlueKid2.png'), width * 0.75, height * 0.29);
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/enemies/packred.png'), width * 0.80, height * 0.29);
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/enemies/packblue.png'), width * 0.85, height * 0.29);
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/enemies/RedKid2.png'), width * 0.90, height * 0.29);
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/player/BlueKid2.png'), width * 0.20, height * 0.45);
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/player/RedKid2.png'), width * 0.20, height * 0.67);
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/sound-image/UnMuteV2.png'), width * 0.65, height * 0.77, 50, 50);
        ...
        this.game.ctx.drawImage(Game.loadNewImage('./assets/img/sound-image/UnMute.png'), width * 0.65, height * 0.85, 50, 50);
