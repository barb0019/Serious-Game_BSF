...
export default class Level5 extends Level {
  ...
  protected speedsbubbles(game: Game): void {
    ...
    this.speedBubble.push(new SpeedsBubble(game, 'van teveel in-game aankopen kan je in geld problemen komen', this.game.canvas.height * 0.3, this.game.canvas.width * 0.75, 100, 500, 'white'));
  }
