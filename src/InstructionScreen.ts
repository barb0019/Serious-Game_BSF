...
export default class InstructionScreen extends Scene {
  ...
  public render(): void {
    ...
    this.game.ctx.drawImage(Game.loadNewImage('./assets/img/BlueKid2.png'), width * 0.75, height * 0.29);
    ...
    this.game.ctx.drawImage(Game.loadNewImage('./assets/img/RedKid2.png'), width * 0.90, height * 0.29);
