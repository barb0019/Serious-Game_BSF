...
export default class Level3 extends Level {
  ...
  protected speedsbubbles(game: Game):void {
    ...
    this.speedBubble.push(new SpeedsBubble(game, 'Games als Fortnite zijn gratis', this.game.canvas.height * 0.36, this.game.canvas.width * 0.72, 100, 500, 'blue'));
    this.speedBubble.push(new SpeedsBubble(game, ',maar toch geven mensen er meer geld aan uit dan een nieuwe game?!', this.game.canvas.height * 0.38, this.game.canvas.width * 0.72, 100, 500, 'blue'));
